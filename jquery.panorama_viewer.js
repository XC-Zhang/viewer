    ...
    return this.each(function(){
      ...
      el.find(" img").load(function () {
        ...
        */ // Commented by ZXC
        ...
        height = el.find(".pv-pano").height() + 2;
        ...
        el.find(".pv-inner").css({
          ...
          "background-position": width / 2 + 1000 + "px 0", // Added by ZXC
        ...
        function handle (e){
            ...
            if (e.type == 'mousedown') {
              ...
              //$(document.body).focus(); // Commented by ZXC
            }
        ...
        function zoom (e){ // Added by ZXC
            $(this).css('background-size', (scale = scale + e.originalEvent.wheelDelta / 120) * 10 + 100 + "%, auto");
        }
        
        $bg.bind('mousedown mouseup mouseleave', handle);
        //$bg.bind('mousewheel', zoom);
